# Extracted from https://github.com/Graph-and-Geometric-Learning/D4Explainer/blob/main/evaluation/in_distribution/ood_stat.py
...
def eval_graph_list(graph_ref_list, grad_pred_list, methods=["degree"]):
    """
